    ...
    "use strict";
        ...
        (function() {
            ...
            var graph = new Rickshaw.Graph({
                ...
                series: [{
                    data: seriesData[0],
                    color: 'rgba(3, 169, 243, 0.5)', // Get Pages contextual color
                    name: 'DB Server'
                }, {
                    data: seriesData[1],
                    color: 'rgba(171, 140, 228, 0.5)', // Get Pages contextual color
                    name: 'Web Server'
                }]
            });
        ...
        (function() {
            ...
            var graph = new Rickshaw.Graph({
                ...
                series: [{
                    data: seriesData[0],
                    color: 'rgba(0, 194, 146, 0.5)', // Get Pages contextual color
                    name: "New users"
                }, {
                    data: seriesData[1],
                    color: 'rgba(251, 150, 120, 0.5)', // Get Pages contextual color
